...
impl Cartridge {
    ...
    pub fn read_prg(&self, addr: u16) -> u8 {
        ...
        match self.mapper {
            ...
            2 | 70 | 71 | 152 => self.read_prg_uxrom(addr, rom_addr),
